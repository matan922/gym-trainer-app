...
export const UsersSolidIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
...
export const UserPlusSolidIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
...
export const CalendarSolidIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
...
export const ClipBoardSolidIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
...
export const ClipBoardChecked = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const DumbbellIconSolid = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    {/* SVG content here */}
  </svg>
)
...
// Export aliases for consistent naming with "IconSolid" suffix
export const HomeIconSolid = HomeSolidIcon
export const UsersIconSolid = UsersSolidIcon
export const UserPlusIconSolid = UserPlusSolidIcon
export const CalendarIconSolid = CalendarSolidIcon
export const CirclePlusIconSolid = CirclePlusSolidIcon
