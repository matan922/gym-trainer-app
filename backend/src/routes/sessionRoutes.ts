...
import { getSessions, getSessionsOfClient, postSession, updateSession, updateSessionStatus } from '../controller/trainer/sessionController.js';
...
router.get("/:clientId", authenticateToken, getSessionsOfClient)
